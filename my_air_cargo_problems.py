...
class AirCargoProblem(Problem):
    ...
    def get_actions(self):
        ...
        def load_actions():
            ...
            # Load(c, p, a) -> get all combinations of Cargo, Planes and Airports
            # Is there a better way to do this? Nested loops are slow.
            for p in self.planes:
                for a in self.airports:
                    for c in self.cargos:
                        # Preconditions
                        # Is it necessary to add conditions Cargo(c), Plane(p) and Airport(a)?
                        ...
                        # Append to list of load actions
                        loads.append(load)
            return loads
        ...
        def unload_actions():
            ...
            # Unload(c, p, a) -> get all combinations of Cargo, Panes and Airports
            for p in self.planes:
                for a in self.airports:
                    for c in self.cargos:
                        # Preconditions
